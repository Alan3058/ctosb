 ...
 * @author liliangang
 * @date 2017年8月18日下午3:15:20
 */
public class SnowflakeBuilder implements NumberBuilder<Long> {

	// ==============================Fields===========================================
	/** 开始时间截 (2017-07-04) */
	private final long startTime = 1499143428466L;
	/** 机器id所占的位数 */
	 ...
	 */
	public SnowflakeBuilder(long workerId, long datacenterId) {
